...
{
    public class L2RegularizerTensorTests
    {
        //------------------------------------------------------------------
        [Test]
        public void Compute_WithPositiveCoefficient_ReturnsExpectedPenalty()
        {
            ...
            var regularizer = new L2RegularizerTensor( new[]
            {
                new[] { w1, w2 },
            } );
        ...
        {
            Assert.Throws<ArgumentNullException>( () => new L2RegularizerTensor( null ) );
        }
        //------------------------------------------------------------------
        [Test]
        public void Constructor_WithEmptyParameterGroups_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>( () => new L2RegularizerTensor( new Tensor[][] { } ) );
        }
        //------------------------------------------------------------------
        [Test]
        public void Constructor_WithGroupsContainingOnlyNulls_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>( () => new L2RegularizerTensor( new[] { new Tensor[] { null, null } } ) );
        }
        //------------------------------------------------------------------
        [Test]
