...
namespace ChaosRL
{
    ...
    public class MLPTensor
    {
        ...
        private readonly LayerTensor[] _layers;
        //------------------------------------------------------------------
        /// <summary>
        ...
        public MLPTensor( int numInputs, int[] layerSizes, bool lastLayerNonLin = false )
        {
            ...
            _layers = new LayerTensor[ layerSizes.Length ];
            int prev = numInputs;
            for (int i = 0; i < layerSizes.Length; i++)
            {
                ...
                _layers[ i ] = new LayerTensor( prev, curr, nonLin: useNonLin );
                prev = curr;
            }
        }
        //------------------------------------------------------------------
